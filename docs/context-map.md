...
| [docs/adr/0008-release-sequencing-and-what-v1-means.md](adr/0008-release-sequencing-and-what-v1-means.md) | You are wondering when v1.0.0 is tagged, why the release waits, why there is no email module, or why the setup page insists a pane is two things. The four decisions taken once five slices had merged. | internal |
